...
namespace PersonHandlerTests
{
    public class PersonHandlerTests
    {
        ...
        private string csvPath = Environment.GetEnvironmentVariable("HOME") + @"C:\Users\Sulai\Dip_Delegates_Task\Tests\DataFiles\processed_data.csv"; // change to appropriate path
