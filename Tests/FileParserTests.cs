...
namespace FileParserTests
{
    public class FileParserTests
    {
        ...
        private string _csvPath = Environment.GetEnvironmentVariable("HOME") + @"C:\Users\Sulai\Dip_Delegates_Task\Tests\DataFiles\data.csv";  // change to appropriate path
        private string _tsvPath = Environment.GetEnvironmentVariable("HOME") + @"C:\Users\Sulai\Dip_Delegates_Task\Tests\DataFiles\data.tsv";  // change to appropriate path

        private string _writeFile = Environment.GetEnvironmentVariable("HOME") + @"C:\Users\Sulai\Dip_Delegates_Task\dataWrite.txt";  // change to appropriate path
